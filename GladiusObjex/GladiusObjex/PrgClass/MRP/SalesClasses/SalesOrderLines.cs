...
{
    public class SalesOrderLines:gsBase
    {
        ...
        public virtual BindingList<ProductDemand> DemandList { get; set; }


        public SalesOrderLines getOrderLines(Guid Ref)
        {
            ObjectManager mng = new ObjectManager(true, "erpconnStr");

            SalesOrderLines mySalesOrderLines = new SalesOrderLines();

            mySalesOrderLines = mng.GetObject<SalesOrderLines>(Ref);
            mySalesOrderLines.DemandList = mng.GetObjectList<ProductDemand>("OrderLineRef = '" + Ref + "'", "");
            return mySalesOrderLines;
        }
        ...
        public SalesOrderLines()
        {
            ...
            DemandList = new BindingList<ProductDemand>();
        }
    }
}
