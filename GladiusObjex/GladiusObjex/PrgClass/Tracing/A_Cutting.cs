...
namespace GladiusObjex.PrgClass.Tracing
{
    public class A_Cutting : gsBase
    {
        ...
        */
        ...
        public BindingList<A_CuttingDetail> CuttingDetail { get; set; }
        public A_Cutting()
        {
            this.TableName = "A_Cutting";
            ...
            this.CuttingDetail = new BindingList<A_CuttingDetail>();
        }
    }
}
