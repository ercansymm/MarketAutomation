...
namespace GladiusObjex.PrgClass.Tracing
{
    public class A_Wicker : gsBase
    {
        ...
        */
        ...
        public BindingList<A_WickerDetail> WickerDetail { get; set; }
        public A_Wicker()
        {
            this.TableName = "A_Wicker";
            ...
            this.WickerDetail = new BindingList<A_WickerDetail>();
        }
    }
}
